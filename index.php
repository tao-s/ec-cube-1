...
$env = isset($_SERVER['APP_ENV']) || getenv('APP_ENV') ? ($_SERVER['APP_ENV']? $_SERVER['APP_ENV'] : getenv('APP_ENV')) : 'dev';
$debug = isset($_SERVER['APP_DEBUG']) || && getenv('APP_DEBUG') ? ($_SERVER['APP_DEBUG']? $_SERVER['APP_DEBUG'] : getenv('APP_DEBUG') ) : ('prod' !== $env);
